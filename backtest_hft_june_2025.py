...
INIT_BAL = 100000.0 # Kullanıcı talebi: 100k Dolar
THRESHOLD = 20      # Agresif Score!
RR_RATIO = 1.5      # Agresif HFT Scalp RR

def run_hft_backtest_june():
    print("=" * 60)
    print(f"   HAZIRAN 2025 - HFT AGGRESSIVE MODE ($100,000 BUDGET)")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print(f"  GENEL SONUC - HAZIRAN 2025 ($100k Bakiye)")
    print("=" * 60)
