...
def run_command(cmd_list):
    ...
    if cmd_list[0] in ["py", "python", "python3"]:
...
def master_training_loop():
    ...
    print("\n--- PHASE 1: INITIAL BACKTEST ---")
    if not run_command([sys.executable, "realistic_backtest_v8.py"]):
        print("Error: Backtest failed.")
        return

    # PHASE 2: AI Analysis
    print("\n--- PHASE 2: AI OPTIMIZATION ---")
    if not run_command([sys.executable, "ai_optimizer.py", "--backtest"]):
